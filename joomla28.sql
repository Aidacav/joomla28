...
-- Tiempo de generación: 28-11-2020 a las 09:58:54
...
--
-- Base de datos: `joomla28`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `aa2jq_action_logs`
--

CREATE TABLE IF NOT EXISTS `aa2jq_action_logs` (
...
--
-- Volcado de datos para la tabla `aa2jq_action_logs`
--

INSERT INTO `aa2jq_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{"action":"login","userid":"721","username":"aida88","accountlink":"index.php?option=com_users&task=user.edit&id=721","app":"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR"}', '2020-11-28 08:52:38', 'com_users', 721, 0, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `aa2jq_action_logs_extensions`
--

CREATE TABLE IF NOT EXISTS `aa2jq_action_logs_extensions` (
  `id` int(10) unsigned NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `aa2jq_action_logs_extensions`
--

INSERT INTO `aa2jq_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Estructura de tabla para la tabla `aa2jq_action_logs_users`
--

CREATE TABLE IF NOT EXISTS `aa2jq_action_logs_users` (
...
--
-- Estructura de tabla para la tabla `aa2jq_action_log_config`
--

CREATE TABLE IF NOT EXISTS `aa2jq_action_log_config` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Volcado de datos para la tabla `aa2jq_action_log_config`
--

INSERT INTO `aa2jq_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Estructura de tabla para la tabla `aa2jq_assets`
--

CREATE TABLE IF NOT EXISTS `aa2jq_assets` (
...
--
-- Volcado de datos para la tabla `aa2jq_assets`
--

INSERT INTO `aa2jq_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Estructura de tabla para la tabla `aa2jq_associations`
--

CREATE TABLE IF NOT EXISTS `aa2jq_associations` (
...
--
-- Estructura de tabla para la tabla `aa2jq_banners`
--

CREATE TABLE IF NOT EXISTS `aa2jq_banners` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `aa2jq_banner_clients`
--

CREATE TABLE IF NOT EXISTS `aa2jq_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `aa2jq_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `aa2jq_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `aa2jq_categories`
--

CREATE TABLE IF NOT EXISTS `aa2jq_categories` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `aa2jq_categories`
--

INSERT INTO `aa2jq_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 721, '2020-11-28 08:48:05', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 721, '2020-11-28 08:48:05', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 721, '2020-11-28 08:48:05', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 721, '2020-11-28 08:48:05', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 721, '2020-11-28 08:48:05', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 721, '2020-11-28 08:48:05', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `aa2jq_contact_details`
--

CREATE TABLE IF NOT EXISTS `aa2jq_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `aa2jq_content`
--

CREATE TABLE IF NOT EXISTS `aa2jq_content` (
  `id` int(10) unsigned NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `aa2jq_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `aa2jq_contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `aa2jq_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `aa2jq_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `aa2jq_content_rating`
--

CREATE TABLE IF NOT EXISTS `aa2jq_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `aa2jq_content_types`
--

CREATE TABLE IF NOT EXISTS `aa2jq_content_types` (
...
--
-- Volcado de datos para la tabla `aa2jq_content_types`
--

INSERT INTO `aa2jq_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Estructura de tabla para la tabla `aa2jq_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `aa2jq_core_log_searches` (
...
--
-- Estructura de tabla para la tabla `aa2jq_extensions`
--

CREATE TABLE IF NOT EXISTS `aa2jq_extensions` (
...
--
-- Volcado de datos para la tabla `aa2jq_extensions`
--

INSERT INTO `aa2jq_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"ecb6043b733728a2840fd85532ca2d2e"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1606553345}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Estructura de tabla para la tabla `aa2jq_fields`
--

CREATE TABLE IF NOT EXISTS `aa2jq_fields` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `aa2jq_fields_categories`
--

CREATE TABLE IF NOT EXISTS `aa2jq_fields_categories` (
...
--
-- Estructura de tabla para la tabla `aa2jq_fields_groups`
--

CREATE TABLE IF NOT EXISTS `aa2jq_fields_groups` (
  `id` int(10) unsigned NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `aa2jq_fields_values`
--

CREATE TABLE IF NOT EXISTS `aa2jq_fields_values` (
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_filters`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_filters` (
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links` (
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Volcado de datos para la tabla `aa2jq_finder_taxonomy`
--

INSERT INTO `aa2jq_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `aa2jq_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_terms`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_terms` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `aa2jq_finder_terms_common`
--

INSERT INTO `aa2jq_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `aa2jq_finder_types`
--

CREATE TABLE IF NOT EXISTS `aa2jq_finder_types` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `aa2jq_languages`
--

CREATE TABLE IF NOT EXISTS `aa2jq_languages` (
...
--
-- Volcado de datos para la tabla `aa2jq_languages`
--

INSERT INTO `aa2jq_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `aa2jq_menu`
--

CREATE TABLE IF NOT EXISTS `aa2jq_menu` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `aa2jq_menu`
--

INSERT INTO `aa2jq_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Estructura de tabla para la tabla `aa2jq_menu_types`
--

CREATE TABLE IF NOT EXISTS `aa2jq_menu_types` (
  `id` int(10) unsigned NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `aa2jq_menu_types`
--

INSERT INTO `aa2jq_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `aa2jq_messages`
--

CREATE TABLE IF NOT EXISTS `aa2jq_messages` (
...
--
-- Estructura de tabla para la tabla `aa2jq_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `aa2jq_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `aa2jq_modules`
--

CREATE TABLE IF NOT EXISTS `aa2jq_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Volcado de datos para la tabla `aa2jq_modules`
--

INSERT INTO `aa2jq_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Estructura de tabla para la tabla `aa2jq_modules_menu`
--

CREATE TABLE IF NOT EXISTS `aa2jq_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `aa2jq_modules_menu`
--

INSERT INTO `aa2jq_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `aa2jq_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `aa2jq_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `aa2jq_overrider`
--

CREATE TABLE IF NOT EXISTS `aa2jq_overrider` (
...
--
-- Estructura de tabla para la tabla `aa2jq_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `aa2jq_postinstall_messages` (
...
--
-- Volcado de datos para la tabla `aa2jq_postinstall_messages`
--

INSERT INTO `aa2jq_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `aa2jq_privacy_consents`
--

CREATE TABLE IF NOT EXISTS `aa2jq_privacy_consents` (
  `id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `aa2jq_privacy_requests`
--

CREATE TABLE IF NOT EXISTS `aa2jq_privacy_requests` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `aa2jq_redirect_links`
--

CREATE TABLE IF NOT EXISTS `aa2jq_redirect_links` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `aa2jq_schemas`
--

CREATE TABLE IF NOT EXISTS `aa2jq_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `aa2jq_schemas`
--

INSERT INTO `aa2jq_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.9.22-2020-09-16');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `aa2jq_session`
--

CREATE TABLE IF NOT EXISTS `aa2jq_session` (
...
--
-- Volcado de datos para la tabla `aa2jq_session`
--

INSERT INTO `aa2jq_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x3963353663646136393461663039633638356565336434346235313262363430, 1, 0, 1606553560, 'joomla|s:868:"";', 721, 'aida88'),
(0x6566613832613632393539643166663131313737353861346530373831316138, 0, 1, 1606553498, 'joomla|s:808:"";', 0, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `aa2jq_tags`
--

CREATE TABLE IF NOT EXISTS `aa2jq_tags` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `aa2jq_tags`
--

INSERT INTO `aa2jq_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 721, '2020-11-28 08:48:05', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `aa2jq_template_styles`
--

CREATE TABLE IF NOT EXISTS `aa2jq_template_styles` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Volcado de datos para la tabla `aa2jq_template_styles`
--

INSERT INTO `aa2jq_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Estructura de tabla para la tabla `aa2jq_ucm_base`
--

CREATE TABLE IF NOT EXISTS `aa2jq_ucm_base` (
...
--
-- Estructura de tabla para la tabla `aa2jq_ucm_content`
--

CREATE TABLE IF NOT EXISTS `aa2jq_ucm_content` (
...
--
-- Estructura de tabla para la tabla `aa2jq_ucm_history`
--

CREATE TABLE IF NOT EXISTS `aa2jq_ucm_history` (
...
--
-- Estructura de tabla para la tabla `aa2jq_updates`
--

CREATE TABLE IF NOT EXISTS `aa2jq_updates` (
...
--
-- Volcado de datos para la tabla `aa2jq_updates`
--

INSERT INTO `aa2jq_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
--
-- Estructura de tabla para la tabla `aa2jq_update_sites`
--

CREATE TABLE IF NOT EXISTS `aa2jq_update_sites` (
...
--
-- Volcado de datos para la tabla `aa2jq_update_sites`
--

INSERT INTO `aa2jq_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1606553346, ''),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1606553559, ''),
(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1606553559, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `aa2jq_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `aa2jq_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Volcado de datos para la tabla `aa2jq_update_sites_extensions`
--

INSERT INTO `aa2jq_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(3, 28);
...
--
-- Estructura de tabla para la tabla `aa2jq_usergroups`
--

CREATE TABLE IF NOT EXISTS `aa2jq_usergroups` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla `aa2jq_usergroups`
--

INSERT INTO `aa2jq_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla `aa2jq_users`
--

CREATE TABLE IF NOT EXISTS `aa2jq_users` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `aa2jq_users`
--

INSERT INTO `aa2jq_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(721, 'Super User', 'aida88', 'rodriguez.jimenez.aida@iescamas.es', '$2y$10$G5m3n95e.ArIEwKiTAGW5.M9jRgBCAqW/uGvZt33J8uZybEp4UKVa', 0, 1, '2020-11-28 08:48:05', '2020-11-28 08:52:38', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `aa2jq_user_keys`
--

CREATE TABLE IF NOT EXISTS `aa2jq_user_keys` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `aa2jq_user_notes`
--

CREATE TABLE IF NOT EXISTS `aa2jq_user_notes` (
  `id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `aa2jq_user_profiles`
--

CREATE TABLE IF NOT EXISTS `aa2jq_user_profiles` (
...
--
-- Estructura de tabla para la tabla `aa2jq_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `aa2jq_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `aa2jq_user_usergroup_map`
--

INSERT INTO `aa2jq_user_usergroup_map` (`user_id`, `group_id`) VALUES
(721, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `aa2jq_utf8_conversion`
--

CREATE TABLE IF NOT EXISTS `aa2jq_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `aa2jq_utf8_conversion`
--

INSERT INTO `aa2jq_utf8_conversion` (`converted`) VALUES
(5);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `aa2jq_viewlevels`
--

CREATE TABLE IF NOT EXISTS `aa2jq_viewlevels` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Volcado de datos para la tabla `aa2jq_viewlevels`
--

INSERT INTO `aa2jq_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indices de la tabla `aa2jq_action_logs`
--
ALTER TABLE `aa2jq_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `aa2jq_action_logs_extensions`
--
ALTER TABLE `aa2jq_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `aa2jq_action_logs_users`
--
ALTER TABLE `aa2jq_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Indices de la tabla `aa2jq_action_log_config`
--
ALTER TABLE `aa2jq_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `aa2jq_assets`
--
ALTER TABLE `aa2jq_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `aa2jq_associations`
--
ALTER TABLE `aa2jq_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indices de la tabla `aa2jq_banners`
--
ALTER TABLE `aa2jq_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `aa2jq_banner_clients`
--
ALTER TABLE `aa2jq_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indices de la tabla `aa2jq_banner_tracks`
--
ALTER TABLE `aa2jq_banner_tracks`
...
--
-- Indices de la tabla `aa2jq_categories`
--
ALTER TABLE `aa2jq_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `aa2jq_contact_details`
--
ALTER TABLE `aa2jq_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indices de la tabla `aa2jq_content`
--
ALTER TABLE `aa2jq_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `aa2jq_contentitem_tag_map`
--
ALTER TABLE `aa2jq_contentitem_tag_map`
...
--
-- Indices de la tabla `aa2jq_content_frontpage`
--
ALTER TABLE `aa2jq_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `aa2jq_content_rating`
--
ALTER TABLE `aa2jq_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `aa2jq_content_types`
--
ALTER TABLE `aa2jq_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indices de la tabla `aa2jq_extensions`
--
ALTER TABLE `aa2jq_extensions`
...
--
-- Indices de la tabla `aa2jq_fields`
--
ALTER TABLE `aa2jq_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `aa2jq_fields_categories`
--
ALTER TABLE `aa2jq_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indices de la tabla `aa2jq_fields_groups`
--
ALTER TABLE `aa2jq_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `aa2jq_fields_values`
--
ALTER TABLE `aa2jq_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indices de la tabla `aa2jq_finder_filters`
--
ALTER TABLE `aa2jq_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indices de la tabla `aa2jq_finder_links`
--
ALTER TABLE `aa2jq_finder_links`
...
--
-- Indices de la tabla `aa2jq_finder_links_terms0`
--
ALTER TABLE `aa2jq_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_terms1`
--
ALTER TABLE `aa2jq_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_terms2`
--
ALTER TABLE `aa2jq_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_terms3`
--
ALTER TABLE `aa2jq_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_terms4`
--
ALTER TABLE `aa2jq_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_terms5`
--
ALTER TABLE `aa2jq_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_terms6`
--
ALTER TABLE `aa2jq_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_terms7`
--
ALTER TABLE `aa2jq_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_terms8`
--
ALTER TABLE `aa2jq_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_terms9`
--
ALTER TABLE `aa2jq_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_termsa`
--
ALTER TABLE `aa2jq_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_termsb`
--
ALTER TABLE `aa2jq_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_termsc`
--
ALTER TABLE `aa2jq_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_termsd`
--
ALTER TABLE `aa2jq_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_termse`
--
ALTER TABLE `aa2jq_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_links_termsf`
--
ALTER TABLE `aa2jq_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `aa2jq_finder_taxonomy`
--
ALTER TABLE `aa2jq_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `aa2jq_finder_taxonomy_map`
--
ALTER TABLE `aa2jq_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indices de la tabla `aa2jq_finder_terms`
--
ALTER TABLE `aa2jq_finder_terms`
...
--
-- Indices de la tabla `aa2jq_finder_terms_common`
--
ALTER TABLE `aa2jq_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indices de la tabla `aa2jq_finder_tokens`
--
ALTER TABLE `aa2jq_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indices de la tabla `aa2jq_finder_tokens_aggregate`
--
ALTER TABLE `aa2jq_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indices de la tabla `aa2jq_finder_types`
--
ALTER TABLE `aa2jq_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indices de la tabla `aa2jq_languages`
--
ALTER TABLE `aa2jq_languages`
...
--
-- Indices de la tabla `aa2jq_menu`
--
ALTER TABLE `aa2jq_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `aa2jq_menu_types`
--
ALTER TABLE `aa2jq_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indices de la tabla `aa2jq_messages`
--
ALTER TABLE `aa2jq_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indices de la tabla `aa2jq_messages_cfg`
--
ALTER TABLE `aa2jq_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indices de la tabla `aa2jq_modules`
--
ALTER TABLE `aa2jq_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `aa2jq_modules_menu`
--
ALTER TABLE `aa2jq_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indices de la tabla `aa2jq_newsfeeds`
--
ALTER TABLE `aa2jq_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indices de la tabla `aa2jq_overrider`
--
ALTER TABLE `aa2jq_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `aa2jq_postinstall_messages`
--
ALTER TABLE `aa2jq_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indices de la tabla `aa2jq_privacy_consents`
--
ALTER TABLE `aa2jq_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indices de la tabla `aa2jq_privacy_requests`
--
ALTER TABLE `aa2jq_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `aa2jq_redirect_links`
--
ALTER TABLE `aa2jq_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indices de la tabla `aa2jq_schemas`
--
ALTER TABLE `aa2jq_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indices de la tabla `aa2jq_session`
--
ALTER TABLE `aa2jq_session`
...
--
-- Indices de la tabla `aa2jq_tags`
--
ALTER TABLE `aa2jq_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `aa2jq_template_styles`
--
ALTER TABLE `aa2jq_template_styles`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `aa2jq_ucm_base`
--
ALTER TABLE `aa2jq_ucm_base`
...
--
-- Indices de la tabla `aa2jq_ucm_content`
--
ALTER TABLE `aa2jq_ucm_content`
...
--
-- Indices de la tabla `aa2jq_ucm_history`
--
ALTER TABLE `aa2jq_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indices de la tabla `aa2jq_updates`
--
ALTER TABLE `aa2jq_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indices de la tabla `aa2jq_update_sites`
--
ALTER TABLE `aa2jq_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indices de la tabla `aa2jq_update_sites_extensions`
--
ALTER TABLE `aa2jq_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indices de la tabla `aa2jq_usergroups`
--
ALTER TABLE `aa2jq_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `aa2jq_users`
--
ALTER TABLE `aa2jq_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `aa2jq_user_keys`
--
ALTER TABLE `aa2jq_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Indices de la tabla `aa2jq_user_notes`
--
ALTER TABLE `aa2jq_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indices de la tabla `aa2jq_user_profiles`
--
ALTER TABLE `aa2jq_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indices de la tabla `aa2jq_user_usergroup_map`
--
ALTER TABLE `aa2jq_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indices de la tabla `aa2jq_viewlevels`
--
ALTER TABLE `aa2jq_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de la tabla `aa2jq_action_logs`
--
ALTER TABLE `aa2jq_action_logs`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `aa2jq_action_logs_extensions`
--
ALTER TABLE `aa2jq_action_logs_extensions`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT de la tabla `aa2jq_action_log_config`
--
ALTER TABLE `aa2jq_action_log_config`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT de la tabla `aa2jq_assets`
--
ALTER TABLE `aa2jq_assets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=60;
--
-- AUTO_INCREMENT de la tabla `aa2jq_banners`
--
ALTER TABLE `aa2jq_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_banner_clients`
--
ALTER TABLE `aa2jq_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_categories`
--
ALTER TABLE `aa2jq_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de la tabla `aa2jq_contact_details`
--
ALTER TABLE `aa2jq_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_content`
--
ALTER TABLE `aa2jq_content`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_content_types`
--
ALTER TABLE `aa2jq_content_types`
  MODIFY `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT de la tabla `aa2jq_extensions`
--
ALTER TABLE `aa2jq_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT de la tabla `aa2jq_fields`
--
ALTER TABLE `aa2jq_fields`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_fields_groups`
--
ALTER TABLE `aa2jq_fields_groups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_finder_filters`
--
ALTER TABLE `aa2jq_finder_filters`
  MODIFY `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_finder_links`
--
ALTER TABLE `aa2jq_finder_links`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_finder_taxonomy`
--
ALTER TABLE `aa2jq_finder_taxonomy`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `aa2jq_finder_terms`
--
ALTER TABLE `aa2jq_finder_terms`
  MODIFY `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_finder_types`
--
ALTER TABLE `aa2jq_finder_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_languages`
--
ALTER TABLE `aa2jq_languages`
  MODIFY `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `aa2jq_menu`
--
ALTER TABLE `aa2jq_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=102;
--
-- AUTO_INCREMENT de la tabla `aa2jq_menu_types`
--
ALTER TABLE `aa2jq_menu_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `aa2jq_messages`
--
ALTER TABLE `aa2jq_messages`
  MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_modules`
--
ALTER TABLE `aa2jq_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=90;
--
-- AUTO_INCREMENT de la tabla `aa2jq_newsfeeds`
--
ALTER TABLE `aa2jq_newsfeeds`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_overrider`
--
ALTER TABLE `aa2jq_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT de la tabla `aa2jq_postinstall_messages`
--
ALTER TABLE `aa2jq_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `aa2jq_privacy_consents`
--
ALTER TABLE `aa2jq_privacy_consents`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_privacy_requests`
--
ALTER TABLE `aa2jq_privacy_requests`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_redirect_links`
--
ALTER TABLE `aa2jq_redirect_links`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_tags`
--
ALTER TABLE `aa2jq_tags`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `aa2jq_template_styles`
--
ALTER TABLE `aa2jq_template_styles`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de la tabla `aa2jq_ucm_content`
--
ALTER TABLE `aa2jq_ucm_content`
  MODIFY `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_ucm_history`
--
ALTER TABLE `aa2jq_ucm_history`
  MODIFY `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_updates`
--
ALTER TABLE `aa2jq_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=78;
--
-- AUTO_INCREMENT de la tabla `aa2jq_update_sites`
--
ALTER TABLE `aa2jq_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `aa2jq_usergroups`
--
ALTER TABLE `aa2jq_usergroups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `aa2jq_users`
--
ALTER TABLE `aa2jq_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=722;
--
-- AUTO_INCREMENT de la tabla `aa2jq_user_keys`
--
ALTER TABLE `aa2jq_user_keys`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_user_notes`
--
ALTER TABLE `aa2jq_user_notes`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `aa2jq_viewlevels`
--
ALTER TABLE `aa2jq_viewlevels`
